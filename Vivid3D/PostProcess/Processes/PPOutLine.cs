...
namespace Vivid.PostProcess.Processes
{
    public class PPOutLine : VPostProcess
    {
        ...
        private Vivid.Texture.Texture2D ib = null;
        ...
        public Vivid.Texture.Texture2D pi = null;
        ...
        public override void PostRender(Texture2D bb)
        {
            ...
            Vivid.PostProcess.PostProcessRender.PBuf.BB.Bind(0);
            pi.Bind(1);
            DrawQuad();
            pi.Release(1);
            Vivid.PostProcess.PostProcessRender.PBuf.BB.Release(0);
    ...
    public class VEOutLine : Vivid.Effect.Effect3D
    {
    ...
    public class VECombineTex : Vivid.Effect.Effect3D
    {
