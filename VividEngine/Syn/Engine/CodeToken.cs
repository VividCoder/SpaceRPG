...
namespace Vivid
{
    ...
    {
        Type, Value, Statement, Define, Op, Flow, Id, Sep, Scope, Array, New, Bool, Assign, BeginLine, Compute, Game, Node, NodeLogic, GameLogic, State, StateLogic, Info, Meta
    }
    ...
    public enum Token
    {
        ...
        GreatEqual, LessEqual, EndLine, Wend, BeginLine, Percent, Return, Compute, ComputeStruct, Vec2, Vec3, Vec4, Matrix4, Matrix3, Game, Node, NodeLogic, GameState, NodeState, GameLogic, StateLogic, Author, Title,
        Copyright, Version, Init, Sub, Thread, Call, Loop, Print, Break,Stop,ForEach,CompileStop,Null
    }
